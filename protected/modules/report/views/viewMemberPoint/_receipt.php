...
<p align="center" style="margin-top:-21px;margin-bottom:0px">Member Point</p>
==============================
<table width="100%" style="color:purple;font-size:12px">
	...
	<tr>
		<td>Point</td><td>:</td><td align="right"><?php echo $point; //echo numberToWords($point); ?></td>
	<tr>

	<tr>
		<td>Last Add Point</td><td>:</td><td align="right"><?php echo $last_update; ?></td>
	<tr>
