...
<p align="center" style="margin-top:-21px;margin-bottom:0px">Add Point</p>
==============================
<table width="100%" style="color:purple;font-size:12px">
	...
	<tr>
		<td>New Point</td><td>:</td><td align="right"><?php echo $new_point; ?></td>
	<tr>

	<tr>
		<td>Old Point</td><td>:</td><td align="right"><?php echo $old_point; ?></td>
	<tr>

	<tr>
		<td>&nbsp</td></td><td>&nbsp;</td><td><hr/ style="border:1px solid purple"></td>
	</tr>
	
	<tr>
		<td>Total Point</td></td><td>:</td ><td align="right"><?php echo $total_point; ?></td>
	</tr>
